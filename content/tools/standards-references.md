...
## 국내 가이드라인 및 보고서 (KISA, PIPC)

국내 공식 기관에서 발간한 AI 보안 및 개인정보보호 관련 핵심 자료들입니다. 글로벌 표준을 한국 실정에 맞게 구체화하거나, 국내 규제 환경에 맞춘 대응 방안을 담고 있어 실무에서 매우 중요합니다.

### 인공지능(AI) 보안 안내서 (KISA)

**요약**: AI 개발 수명 주기(계획·설계, 데이터 수집·준비, 모델 개발, 모델 배포, 모니터링·유지보수, 파기)별 보안 요구사항과 **48개 항목의 상세 체크리스트**를 포함하고 있는 가장 핵심적인 국내 자료입니다. 2026년 3월에 업데이트된 최신 정오 수정본을 확인하세요.

**원문**: [KISA 인공지능(AI) 보안 안내서 다운로드 페이지](https://www.kisa.or.kr/2060204/form?postSeq=19&lang_type=KO)

### 글로벌 AI 안전 및 보안 규범 분석 보고서 (KISA Insight)

**요약**: 미국 행정명령, EU AI법 등 급변하는 글로벌 AI 규범 동향과 그에 따른 시사점을 심층 분석한 KISA의 정기 보고서입니다. 거버넌스 수립 및 글로벌 컴플라이언스 대응 시 전략적 참고 자료로 활용됩니다.

**원문**: [KISA 지식플랫폼 > Insight 게시판](https://www.kisa.or.kr/20202) (게시판 내 '인공지능(AI) 안전 및 보안 규범 분석' 검색)

### KISA 지식플랫폼 (법령·가이드라인)

**요약**: KISA에서 발간하는 보안 취약점 점검, 제로트러스트, 소프트웨어(SW) 공급망 보안 가이드라인 등 다양한 인프라 및 플랫폼 보안 안내서를 모두 모아볼 수 있는 통합 게시판입니다.

**원문**: [KISA 지식플랫폼 > 법령·가이드라인](https://www.kisa.or.kr/2060204/list)

### 생성형 AI 개발·활용을 위한 개인정보 처리 안내서 (PIPC)

**요약**: 개인정보보호위원회(PIPC)에서 발간한 자료로, 생성형 AI 서비스의 각 단계(학습 데이터 수집, 모델 학습, 서비스 제공)에서 개인정보를 안전하게 처리하기 위한 원칙과 기준을 제시합니다.

**원문**: [개인정보보호위원회 누리집 > 법령·자료 > 가이드라인](https://www.pipc.go.kr)
...
| KISA AI 보안 안내서 | 생애주기별 보안 요구사항 | 국내 환경에 최적화된 보안 내재화 및 체크리스트 |
