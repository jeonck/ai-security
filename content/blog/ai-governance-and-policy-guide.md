...
### ② AI 정책 (AI Policy)
* **정의**: AI 거버넌스의 하위 분야로, AI가 어떻게 개발, 사용, 제한, 장려 또는 감독되어야 하는지에 대한 **의도적인 규칙, 계획 또는 입장을** 말합니다.
* **구체적 사례**:
...
* **정의**: 입법 기관(Legislative body)에 의해 제안되거나 통과된 **법률을** 의미합니다. AI 정책보다 더 좁은 범위의 개념이며, **가장 강력한 법적 강제력을** 갖습니다.
* **구체적 사례**:
...
* **AGI (Artificial General Intelligence, 범용 인공지능)**:
  * 실무적 기준: **중간 수준의 인간(Median Human)과 대등한 인지 능력을** 갖춘 AI 시스템. 특정 도메인을 넘어 인간이 수행하는 범용적 지적 업무를 고루 해낼 수 있는 단계입니다.
* **ASI (Artificial Superintelligence, 인공 초지능)**:
  * 실무적 기준: **인류 전체의 인지 능력을 모두 합친 것보다 더 뛰어난 인지 능력을** 갖춘 AI 시스템. 인간이 인지하고 이해할 수 있는 지적 한계를 아득히 뛰어놓은 상태를 뜻합니다.

> "효과적인 AI 거버넌스 프레임워크는 이미 존재하는 과거의 기술이 아닌, **다가올 미래의 AI 역량(Future Capabilities)을 예측하고 대비하는 방향으로** 맞춰져야 합니다."
...
* **Tennessee ELVIS Act (Ensuring Likeness Voice and Image Security Act)** *(2024년 7월 1일 시행)*
  * 유명인뿐만 아니라 **모든 개인을** 대상으로 허가받지 않은 목소리(Voice) 및 초상(Likeness, Image)을 AI를 활용해 도용하거나 복제하는 행위를 금지하여 AI 딥페이크로부터 인격을 보호합니다.
* **WA HB-2225 (워싱턴주 법안)**
  * 사용자가 AI와 대화하고 있음을 투명하게 알리는 고지(Disclosure) 조치 의무화.
  * 낭만적 관계 모방, 아첨(Sycophancy)을 통한 조작, 미성년자에게 부모로부터 비밀을 유지하도록 유도하는 행위 등 사용자와의 감정적 관계를 악용하려는 **조작적 기술(Manipulative Techniques) 방지를** 위한 합리적 조치 요구.
...
2. **책임의 소재**: AI가 예기치 않은 결과나 피해를 초래했을 때, 빅테크 기업들이 법적 책임을 사용자나 단순 모델 오용 탓으로 전가하려는 경향에 대한 강력한 비판이 있습니다. **책임은 도구가 아닌 모델 개발사나 운영 주체(인간)에게 전적으로 귀속되어야 한다는** 대원칙이 강조됩니다.
